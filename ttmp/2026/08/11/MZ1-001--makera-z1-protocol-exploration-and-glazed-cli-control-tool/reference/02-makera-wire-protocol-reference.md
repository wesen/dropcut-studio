---
Title: Makera Wire Protocol Reference
Ticket: MZ1-001
Status: active
Topics:
    - protocol
...
Owners: []
RelatedFiles:
    - Path: repo://dropcut-studio/ttmp/2026/08/11/MZ1-001--makera-z1-protocol-exploration-and-glazed-cli-control-tool/scripts/01-frame-vectors.py
      Note: Generates and cross-checks the golden frame vectors quoted in this reference
    - Path: repo://dropcut-studio/ttmp/2026/08/11/MZ1-001--makera-z1-protocol-exploration-and-glazed-cli-control-tool/vendor/community-carvera-controller/carveracontroller/WIFIStream.py
      Note: UDP 3333 discovery, TCP 2222 transport and the connect-based busy check
    - Path: repo://dropcut-studio/ttmp/2026/08/11/MZ1-001--makera-z1-protocol-exploration-and-glazed-cli-control-tool/vendor/community-carvera-controller/carveracontroller/protocols/detector.py
      Note: 'Active protocol probe: unframed ''echo echo'' and silence-means-makera'
ExternalSources:
    - https://github.com/Carvera-Community/Carvera_Controller
    - https://github.com/MakeraInc/CarveraController
Summary: 'Terse, citation-dense specification of the Makera/Carvera wire protocol: framing, CRC, packet types, detection, command surface, escaping, report grammars and file transfer. The lookup companion to the MZ1-001 design guide.'
LastUpdated: 2026-08-11T17:00:00-04:00
WhatFor: Keeping open in a second window while implementing pkg/makera.
WhenToUse: When you need one specific protocol fact fast, without re-reading the design guide's prose.
---
