---
Title: MakeraInc/CarveraController README
Ticket: MZ1-001
Status: active
Topics:
    - research
...
Summary: "OEM controller repository overview; source of the original framed protocol."
...
CarveraController is released under the GNU GPL v3, which you can find at [http://www.gnu.org/licenses/gpl-3.0.en.html](http://www.gnu.org/licenses/gpl-3.0.en.html)

## Installation

## Windows Installation

[![Windows Setup](https://github.com/MakeraInc/CarveraController/raw/main/img/Windows-Setup.png)](https://github.com/MakeraInc/CarveraController/blob/main/img/Windows-Setup.png)
...
[![USB Driver Setup1](https://github.com/MakeraInc/CarveraController/raw/main/img/USB-Driver-Setup-1.png)](https://github.com/MakeraInc/CarveraController/blob/main/img/USB-Driver-Setup-1.png)
...
[![USB Driver Setup2](https://github.com/MakeraInc/CarveraController/raw/main/img/USB-Driver-Setup-2.png)](https://github.com/MakeraInc/CarveraController/blob/main/img/USB-Driver-Setup-2.png)
...
[![Mac OS Setup](https://github.com/MakeraInc/CarveraController/raw/main/img/Mac-Setup2.png)](https://github.com/MakeraInc/CarveraController/blob/main/img/Mac-Setup2.png)
...
[![APP Damage](https://github.com/MakeraInc/CarveraController/raw/main/img/APP-Damage-Error.png)](https://github.com/MakeraInc/CarveraController/blob/main/img/APP-Damage-Error.png)
...
[![APP Damage Solution](https://github.com/MakeraInc/CarveraController/raw/main/img/APP-Damage-solution.png)](https://github.com/MakeraInc/CarveraController/blob/main/img/APP-Damage-solution.png)
...
1. Extract the carvera controller-x.x.x-x86\_64-linux.tar.xz file to /path/yourApp
...
4. (On centos system):CentOS typically uses firewalld as the firewall management tool. You can follow these steps to allow access to UDP port 3333:
	```
